...
# generated link-design end marker.  The generated run is intentionally
# patched per profile so a placement-dependent timing miss can be retried
# without ever relaxing the final timing gate.
