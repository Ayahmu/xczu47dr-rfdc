proc create_ddr_axi_smartconnect_design {} {
  ...
  set_property -dict [list CONFIG.ADDR_WIDTH {35} CONFIG.DATA_WIDTH {512} CONFIG.HAS_BRESP {1} CONFIG.HAS_BURST {1} CONFIG.HAS_CACHE {1} CONFIG.HAS_LOCK {1} CONFIG.HAS_PROT {1} CONFIG.HAS_QOS {1} CONFIG.HAS_RRESP {1} CONFIG.HAS_WSTRB {1} CONFIG.PROTOCOL {AXI4} CONFIG.READ_WRITE_MODE {READ_WRITE}] $M_AXI_DDR
