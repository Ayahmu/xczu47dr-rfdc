...
proc create_ddr_axi_smartconnect_design {} {
  ...
  set S_AXI_DM [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_DM ]
  set_property -dict [ list \
  ...
  set S_AXI_WAVE [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_WAVE ]
  set_property -dict [ list \
    CONFIG.ADDR_WIDTH {64} \
  ...
  set_property -dict [ list \
    CONFIG.ASSOCIATED_BUSIF {S_AXI_PS:S_AXI_DM:S_AXI_WAVE:M_AXI_DDR} \
  ...
  connect_bd_intf_net [get_bd_intf_ports S_AXI_DM] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net [get_bd_intf_ports S_AXI_WAVE] [get_bd_intf_pins smartconnect_0/S02_AXI]
