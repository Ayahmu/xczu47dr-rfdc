...
def make_single_trigger_sequence(sample_count: int) -> np.ndarray:
    """Return one finite record that waits for a single Trigger."""
...
__all__ = ["make_trigger_sequence", "make_single_trigger_sequence"]
