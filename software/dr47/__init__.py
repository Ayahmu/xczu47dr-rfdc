...
from .sequence import make_single_trigger_sequence, make_trigger_sequence
...
__all__ += [name for name in ("WAVEDDR0_MAGIC", "WAVESTR0_MAGIC", "WAVEINS0_MAGIC") if name in globals()]
