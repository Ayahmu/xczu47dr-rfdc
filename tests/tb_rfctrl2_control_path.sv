...
module tb_rfctrl2_control_path;
  ...
  task wait_for_status_response;
    ...
    begin
      timeout_cycles = 0;
      while ((response_count < 18) && (timeout_cycles < 80)) begin
        @(negedge clk);
  ...
  initial begin
    ...
    check_condition(response_count == 18, "STATUS must produce eighteen RFRESP2 words");
    ...
    check_condition(responses[2] == 64'h0000007800510002, "response sequence mismatch");
